      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
              ...
              <div className="bg-white shadow-lg rounded-xl p-6 flex items-center justify-between hover:shadow-xl transition">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <div className="text-gray-600">info@financepro.com</div>
                  </div>
                </div>
                <a
          ...
          <div className="flex items-center justify-center">
            <div className="w-full bg-gradient-to-r from-gray-600 to-yellow-600 text-white rounded-2xl shadow-2xl p-10 text-center animate-fade-in">
              <h3 className="text-3xl font-extrabold mb-4">Connect Instantly 🚀</h3>
              <p className="text-lg mb-6 opacity-90">
                Use the buttons below to call, email, or message us directly. 
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center gap-2 bg-green-500 hover:bg-green-600 text-white px-8 py-4 rounded-xl font-semibold text-lg transition transform hover:scale-105 shadow-lg"
              >
        ...
        <div className="mt-16 bg-white shadow-lg rounded-xl overflow-hidden animate-slide-up">
          <iframe
            title="Google Map"
