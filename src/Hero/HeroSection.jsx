...
const HeroSection = () => {
  return (
    <section
      ...
      // 👆 added top padding equal to navbar height (20 = 80px, md:24 = 96px)
    >
        ...
        <div className="max-w-4xl mx-auto animate-fade-in">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <a
              ...
              className="relative px-8 py-4 text-lg rounded-full border border-md text-white font-semibold overflow-hidden transition-all duration-500 ease-out"
            >
              <span className="relative z-10">Book a Free Consultation</span>
              <span className="absolute inset-0 bg-gradient-to-r from-yellow-600 to-gray-600 opacity-0 transition-opacity duration-500 ease-out hover:opacity-100"></span>
            </a>
          </div>
        </div>
      </div>
